...
import tunisiamall.handler.ProdEnsRBHandler;


public class ResBoutiqueProdBoutiqueList extends List implements CommandListener, Runnable{
    ...
    public ResBoutiqueProdBoutiqueList() throws ParserConfigurationException, SAXException, IOException {
        super("Liste des Produits", IMPLICIT);
            ...
            ProdEnsRBHandler prodHandler1 = new ProdEnsRBHandler(idBoutique, nomEnseigne);
            ...
            produits=prodHandler1.getProdBoutClass();
    ...
    public void commandAction(Command c, Displayable d) {
     ...
     Midlet.midlet.disp.setCurrent(new ResBoutiqueProduitForm());  
             ...
             Midlet.midlet.disp.setCurrent(new ResBoutiqueModifierProForm(n.getId(),0,idBoutique));
         }
         //ajouter un produit
